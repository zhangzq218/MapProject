...
import com.meitu.mapproject.widget.CustomFrameLayout;
import com.meitu.mapproject.widget.view.CustomView;
import com.meitu.mapproject.widget.IEvent;
import com.meitu.mapproject.widget.ViewManager;
...
public class MainActivity extends BaseActivity implements MainCallback {
    ...
    private IEvent<CustomView> iEvent;
    ...
    @OnClick({R.id.add_btn, R.id.save_btn, R.id.add_sensity_btn, R.id.sub_sensity_btn, R.id.add_text_btn})
    ...
    protected void initData() {
        ...
        iEvent = new ViewManager();
        mMapFl.setiEvent(iEvent);
    ...
    private void addView() {
        ...
        iEvent.setCurrentView(mCustomView);
        iEvent.setSensity(mSensity);
    }
